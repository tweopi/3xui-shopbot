<div align="center" markdown>
      <h1>Remnawave ShopBot (ex 3X-ui ShopBot) | Telegram-бот для продажи VPN</h1>
<p align="center">
...
**Remnawave ShopBot** — комплексное решение для автоматизированной продажи VLESS‑конфигураций через Telegram с глубокой интеграцией в панель **Remnawave Platform** и собственной веб‑панелью на базе Tabler.

## [Поддержка по проекту](https://t.me/t_shift_supportbot)

## 👥 Группа для соискателей

Присоединяйтесь к нашей группе: [remnawave-shopbot](https://t.me/t_shift_supportbot)
...
- Мульти‑хост: любое число серверов Remnawave Platform, централизованное управление.
...
3) Установленная панель Remnawave Platform на одном или нескольких серверах.
...
```bash
curl -sSL https://raw.githubusercontent.com/tweopi/remnawave-shopbot/install.sh | sudo bash
```
...
3) Добавьте хост Remnawave Platform в «Настройки → Управление хостами» (URL панели, логин/пароль Remnawave Platform, inbound id).
...
```bash
curl -sSL https://raw.githubusercontent.com/tweopi/remnawave-shopbot/main/install.sh | sudo bash
